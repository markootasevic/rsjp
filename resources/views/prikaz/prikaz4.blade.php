...
<div id="demo">
  <h1>Dobrodosli! Popunite formulare prema uputstvima.</h1>
  <h2>Ministarstvo finansija - test</h2>
  ...
  <table id="table" class="table table-hover table-mc-light-blue">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td data-title="Name">Dobrodosli! Popunite formulare prema uputstvima.</td>
          <td data-title="Link">
